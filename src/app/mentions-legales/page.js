    ...
    <main className="flex items-center justify-center p-6 mt-10">
      <div className="w-full max-w-lg bg-white/90 backdrop-blur-xl p-8 rounded-2xl shadow-xl border border-white/40">
        ...
        <p className="text-gray-700">
          Ce site est un projet personnel non commercial. Nom de l’éditeur :
          **PokéDoc** Email : contact@pokedoc.fr
        </p>
        ...
        <p className="text-gray-700">
          Pokémon est une marque appartenant à **Nintendo / Game Freak / The
          Pokémon Company**. Ce site n’est **pas officiel** et n’a aucun lien
          avec ces entreprises. Les images et noms de Pokémon sont utilisés à
          titre de fansite.
        </p>
        <h2 className="text-2xl font-bold mt-6">Données personnelles</h2>
        <p className="text-gray-700">
          PokéDoc ne collecte aucune donnée personnelle. Aucun cookie de
          tracking n’est utilisé sur le site.
        </p>
