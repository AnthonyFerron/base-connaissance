  ...
  return (
    ...
    >
        ...
        <p className="text-gray-700 mb-4">
          PokéDoc est une application créée par un passionné de Pokémon, dans
          le but d’offrir une interface claire et moderne pour explorer les différents Pokémon,
          leurs statistiques, leurs types et bien plus encore.
        </p>

        <p className="text-gray-700 mb-4">
          Le projet n’a aucun but commercial : c’est un **fansite**, conçu pour apprendre,
          s’amuser et rendre hommage à l’univers Pokémon.
        </p>
